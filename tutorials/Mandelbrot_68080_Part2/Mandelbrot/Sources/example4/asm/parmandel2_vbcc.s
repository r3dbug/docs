...
l43
	...
	fmul.d	_stepi,fp0
	fadd.d	_mini,fp0
	fmove.d	fp0,(0+l68,a7)
	move.l	(4+l68,a7),4+_y1
	move.l	(0+l68,a7),_y1
	moveq	#0,d0
	move.w	_x,d0
	fmove.l	d0,fp0
	...
	moveq	#0,d1
	move.w	_MaxIter,d1
	fmove.d	(0+l68,a7),fp1
	fmove.d	(0+l68,a7),fp3
	fmove.d	(0+l68,a7),fp5
	fmove.d	(0+l68,a7),fp7
	jsr	_Par4IterateAsm
	moveq	#0,d2
	move.w	_IterP1,d2
	moveq	#0,d1
...
l67	freg	fp2/fp3/fp4/fp5/fp6/fp7
	fmovem.x	(a7)+,l67
l68	equ	96
	add.w	#12,a7
	rts
