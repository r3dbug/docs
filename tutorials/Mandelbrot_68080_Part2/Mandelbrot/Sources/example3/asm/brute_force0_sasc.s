...
___main__5:
              ...
              BRA.W          ___main__14              ;6000 0118 
___main__6:
              CLR.W          __MERGEDBSS+$14(A4)      ;426c 0014 
              BRA.W          ___main__12              ;6000 0100 
___main__7:
              LEA            __MERGEDBSS+$20(A4),A1   ;43ec 0020 
              CLR.L          (A1)+                    ;4299 
              CLR.L          (A1)+                    ;4299 
              LEA            __MERGEDBSS+$30(A4),A0   ;41ec 0030 
              CLR.L          (A0)+                    ;4298 
              CLR.L          (A0)+                    ;4298 
              CLR.L          (A1)+                    ;4299 
              CLR.L          (A1)+                    ;4299 
              ...
              FADD.D         __MERGEDBSS+$80(A4),FP0  ;f22c 5422 0080 
              FMOVE.D        FP0,__MERGEDBSS+$48(A4)  ;f22c 7400 0048 
              MOVEQ.L        #$0,D0                   ;7000 
              ...
              AND.L          D0,D1                    ;c280 
              FADD.L         D1,FP1                   ;f201 40a2 
              FMUL.D         __MERGEDBSS+$58(A4),FP1  ;f22c 54a3 0058 
              FADD.D         __MERGEDBSS+$70(A4),FP1  ;f22c 54a2 0070 
              FMOVE.D        FP1,(A0)+                ;f218 7480 
              MOVE.W         __MERGEDBSS+$1e(A4),__MERGEDBSS+$1c(A4);396c 001e 001c 
              FMOVE.X        FP0,FP7                  ;f200 0380 
              FMOVE.X        FP1,FP6                  ;f200 0700 
              BRA.B          ___main__9               ;6042 
___main__8:
              LEA            __MERGEDBSS+$20(A4),A1   ;43ec 0020 
              FMOVE.D        (A1)+,FP0                ;f219 5400 
              FMUL.W         #$2,FP0                  ;f23c 5023 0002 
              FMUL.D         (A1),FP0                 ;f211 5423 
              FADD.B         FP7,FP0                  ;f200 1c22 
              FMOVE.D        FP0,(A1)+                ;f219 7400 
              FMOVE.D        (A1)+,FP1                ;f219 5480 
              FSUB.D         (A1),FP1                 ;f211 54a8 
              FADD.B         FP6,FP1                  ;f200 18a2 
              FMOVE.D        FP1,__MERGEDBSS+$20(A4)  ;f22c 7480 0020 
              FMUL.B         FP1,FP1                  ;f200 04a3 
              FMOVE.D        FP1,__MERGEDBSS+$30(A4)  ;f22c 7480 0030 
              FMUL.B         FP0,FP0                  ;f200 0023 
              FMOVE.D        FP0,(A1)+                ;f219 7400 
              SUBQ.W         #$1,__MERGEDBSS+$1c(A4)  ;536c 001c 
___main__9:
              TST.W          __MERGEDBSS+$1c(A4)      ;4a6c 001c 
              BEQ.B          ___main__11              ;6716 
___main__10:
              FMOVE.D        __MERGEDBSS+$30(A4),FP0  ;f22c 5400 0030 
              FADD.D         __MERGEDBSS+$38(A4),FP0  ;f22c 5422 0038 
              FCMP.W         #$4,FP0                  ;f23c 5038 0004 
              FBULE.W        ___main__8               ;f28d ffa4 
___main__11:
              MOVEQ.L        #$0,D0                   ;7000 
              MOVE.W         __MERGEDBSS+$14(A4),D0   ;302c 0014 
              MOVEQ.L        #$0,D1                   ;7200 
              ...
              AND.W          __MERGEDBSS+$1c(A4),D2   ;c46c 001c 
              MOVEQ.L        #$0,D3                   ;7600 
              MOVE.W         D2,D3                    ;3602 
              MOVE.L         D3,D2                    ;2403 
