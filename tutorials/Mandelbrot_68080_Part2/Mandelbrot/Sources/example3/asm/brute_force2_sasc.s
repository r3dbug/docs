...
___main__5:
              ...
              BRA.W          ___main__10              ;6000 00ac 
___main__6:
              CLR.W          __MERGEDBSS+$14(A4)      ;426c 0014 
              BRA.W          ___main__8               ;6000 0094 
___main__7:
              MOVEQ.L        #$0,D0                   ;7000 
              ...
              FMOVE.D        FP1,__MERGEDBSS+$40(A4)  ;f22c 7480 0040 
              MOVEQ.L        #$0,D0                   ;7000 
              MOVE.W         __MERGEDBSS+$1e(A4),D0   ;302c 001e 
              FMOVE.X        FP1,FP0                  ;f200 0400 
              FMOVE.D        __MERGEDBSS+$48(A4),FP1  ;f22c 5480 0048 
              BSR.W          IterateAsmVampire0       ;6100 0000 
              MOVE.W         D0,__MERGEDBSS+$1c(A4)   ;3940 001c 
              MOVEQ.L        #$0,D1                   ;7200 
              MOVE.W         __MERGEDBSS+$14(A4),D1   ;322c 0014 
              MOVEQ.L        #$0,D2                   ;7400 
              MOVE.W         __MERGEDBSS+$16(A4),D2   ;342c 0016 
              ANDI.W         #$ff,D0                  ;0240 00ff 
              MOVEQ.L        #$0,D3                   ;7600 
              MOVE.W         D0,D3                    ;3600 
              MOVE.L         D1,D0                    ;2001 
              MOVE.L         D2,D1                    ;2202 
