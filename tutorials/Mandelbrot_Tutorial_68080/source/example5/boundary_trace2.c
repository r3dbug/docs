...
/*
 * Same as example5/boundary_trace2.c but with compiler optimizations:
 * - VASM: -opt-speed
 * - SASC: optimize opttime
 *
 * Speed improvement: almost nothing ...
 * (Conclusion: nothing beets hand optimized assembly / code:)
 *
...
UWORD __asm IterateAsmVampire1(register __fp0 double x, 
	...
	register __d0 UWORD maxit);
/* parmandel*/
__inline UWORD __asm SingleIterateAsm(register __fp0 double x,
                    register __fp1 double y,
                    register __d0 UWORD MaxIter);
                    
__inline void __asm Par2IterateAsm(register __fp0 double x1,
                    register __fp1 double y1,
                    register __fp2 double x2,
                    register __fp3 double y2,
                    register __d1 UWORD MaxIter);

__inline void __asm Par4IterateAsm(register __fp0 double x1,
                    register __fp1 double y1,
                    register __fp2 double x2,
                    register __fp3 double y2,
